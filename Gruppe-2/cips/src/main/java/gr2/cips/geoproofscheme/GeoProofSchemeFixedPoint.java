 ...
 */
public class GeoProofSchemeFixedPoint extends GeoProofSchemeElement {
	private GeoProofSchemeElement point1;
	private GeoProofSchemeElement point2;	
	private double parameter;

	public GeoProofSchemeFixedPoint(String id,GeoProofSchemeElement point1, GeoProofSchemeElement point2,
			double parameter) {
		this.setID(id);
		this.point1 = point1;
		this.point2 = point2;
	...
	public String toString() {
		return "Point1:(" + this.point1.toString() + "), Point2:(" + this.point1.toString() + "), Parameter:" + this.parameter;
	}
}
